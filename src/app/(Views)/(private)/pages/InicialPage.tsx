...
export function InicialPage() {
  ...
  return (
    <div id="inicialPage" className="w-full space-y-4 my-4">
        ...
        <div className="flex space-x-3 lg:hidden">
          <button
            ...
            className="rounded-full bg-zinc-200 p-2 relative cursor-pointer
              hover:-translate-y-1 hover:bg-purple-600 hover:text-white transition-all duration-300 group"
          >
      ...
      <div className="w-full flex space-x-2 p-2 rounded-lg bg-zinc-200 text-black">
        ...
        <input
          placeholder="Procure por perguntas, matérias e tudo mais..."
