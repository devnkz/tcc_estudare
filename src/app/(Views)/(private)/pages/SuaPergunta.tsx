...
export function SuaPerguntaPage() {
  ...
  return (
    <div
      id="suaPerguntaPage"
      className="h-screen w-full my-12 flex flex-col items-center space-y-8"
    >
      <div className="space-y-4 w-4/5">
        ...
        <p className="text-gray-600 text-center">
          Tem alguma dúvida? Não hesite em perguntar! Aproveite este espaço para
          esclarecer seus questionamentos e avançar nos seus estudos.
        </p>
      </div>
      ...
      <div className="w-4/5 flex justify-center items-center">
        <div className="w-full flex flex-col gap-4">
          ...
          <div className="w-full space-y-4">
            <h2 className="bg-zinc-200 p-4 rounded-lg text-zinc-600">
              Selecione o componente referente á sua pergunta
            </h2>
            <div className="flex space-x-4">
              ...
              <button
                className="bg-purple-600 p-2 rounded-lg text-white cursor-pointer
      ...
      <div className="w-4/5 rounded-lg border-1 border-zinc-700">
        <header className="flex w-full justify-between bg-zinc-300 p-4 rounded-t-lg">
          <h1 className="font-bold">
            Perguntas já feitas que podem te responder
          </h1>
          <ArrowDownIcon className="h-6 w-6" />
        </header>
        <div className="p-4 h-[200px] flex justify-center items-center">
          <p>
            Escreva sua pergunta e sugeriremos perguntas semelhantes que já
            foram respondidas!
          </p>
        </div>
      </div>
