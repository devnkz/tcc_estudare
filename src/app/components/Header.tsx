        ...
        <ul className="flex gap-4 items-center justify-center">
          ...
          <div className="flex space-x-3">
            <button
              ...
              className="rounded-full bg-zinc-200 p-2 relative cursor-pointer hover:-transplate-y-1 hover:bg-purple-600 hover:text-white trasition-all duration-300 group"
            >
