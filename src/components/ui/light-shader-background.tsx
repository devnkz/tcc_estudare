...
const fragmentShader = `
  ...
  vec4 cppn_fn(vec2 coordinate, float in0, float in1, float in2) {
    ...
    * buf[7]
    ...
    // Inverter cores para tema claro (1.0 - valor)
    vec3 lightColor = vec3(1.0 - buf[0].x, 1.0 - buf[0].y, 1.0 - buf[0].z);
    
    // Adicionar tint roxo suave
    vec3 purpleTint = vec3(0.95, 0.92, 0.98);
    lightColor = mix(lightColor, purpleTint, 0.6);
...
function ShaderPlane() {
  ...
  useFrame((state) => {
    ...
    materialRef.current.iTime = state.clock.elapsedTime * 0.5; // Mais lento para tema claro
...
export default function LightShaderBackground() {
  return (
    <div
    ...
    >
      ...
      {/* Overlay gradiente sutil para suavizar */}
